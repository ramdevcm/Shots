...
public class CameraActivity extends Activity implements View.OnClickListener {
    ...
    private int     mType;//Type of shooting
    private boolean isToast = true;//Whether to play the toast, in order to ensure that the for loop is only played once
...
Manually crop the picture*/
        mCropImageView.crop(new CropListener() {
            ...
            public void onFinish(Bitmap bitmap) {
                ...
                /*Save the picture to the sdcard and return the picture path*/
